...
def get_RUL_dataloader(discharge_capacities, train_batteries, test_batteries, change_indices, window_size, stride, channels,scenario):
    ...
    if(scenario ==1):
        ...
        return train_dataloader_RUL_scenario1, train_dataloader_RUL_temp_scenario1, test_dataloader_RUL_scenario1
        ...
        return train_dataloader_RUL_scenario2, train_dataloader_RUL_temp_scenario2, test_dataloader_RUL_scenario2