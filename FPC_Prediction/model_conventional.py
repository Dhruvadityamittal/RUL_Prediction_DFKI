...
class LSTM_Model_Conventional(nn.Module):
    ...
    def __init__(self,input_size,channels):
        ...
        self.LSTM5 = nn.LSTM(input_size = 16, hidden_size = 32, num_layers = num_layers,batch_first=True)

        self.flatten = nn.Flatten()
        self.Linear1 = nn.Linear(224,128)
        self.Linear2 = nn.Linear(128,1343)
...
class CNN_Model_Conventional(nn.Module):
    ...
    def __init__(self,input_size, channels):
        ...
        self.conv1 = nn.Conv1d(channels,16,kernel_size = filter_size_1, stride=1)
        self.batch_norm1 = nn.BatchNorm1d(16)
        self.max_pool1 = nn.MaxPool1d(2)
        

        self.conv2 = nn.Conv1d(16,32, kernel_size = filter_size_1, stride = 1)
        self.batch_norm2 = nn.BatchNorm1d(32)
        self.max_pool2 = nn.MaxPool1d(2)

        self.conv3 = nn.Conv1d(32,64, kernel_size = filter_size, stride = 1)
        self.batch_norm3 = nn.BatchNorm1d(64)
        self.max_pool3 = nn.MaxPool1d(2)

        self.conv4 = nn.Conv1d(64,32, kernel_size = filter_size, stride = 1)
        self.batch_norm4 = nn.BatchNorm1d(32)
        self.max_pool4 = nn.MaxPool1d(2)

        self.conv5 = nn.Conv1d(32,16, kernel_size = filter_size, stride = 1)
        ...
        # self.a = nn.Linear()
        self.Linear2 = nn.Linear(100,1343)
